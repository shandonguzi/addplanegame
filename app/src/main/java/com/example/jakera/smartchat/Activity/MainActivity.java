...
import com.example.planegame.GameActivity;
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ...
    private RadioButton rb_foot_btn01,rb_foot_btn02,rb_foot_btn03,rb_foot_btn04,rb_foot_btn05;
...
//        recognizerHelper=new RecognizerHelper(this,speechRecognizer,mReconizerDialog);
    ...
    private void initView() {
        ...
        rb_foot_btn05=(RadioButton)findViewById(R.id.rb_foot_btn05);
        ...
        radioButtons.add(rb_foot_btn05);
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(this,"congratulations,your application granted success...",Toast.LENGTH_LONG).show();
...
//                  recognizerHelper.recognizeStream(Environment.getExternalStorageDirectory() + "/smart_chat_recorder_audios/yinfu.pcm");
                    ...
                    break;
                case SmartChatConstant.PAGE_FIVE:
                    rb_foot_btn05.setChecked(true);
                    changeRadioButtonState(SmartChatConstant.PAGE_FIVE);
                    setTitlebar(SmartChatConstant.PAGE_FIVE);
                    break;
            }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId){
            ...
            case R.id.rb_foot_btn04:
                ...
                changeRadioButtonState(SmartChatConstant.PAGE_FOUR);
                break;
            case R.id.rb_foot_btn05:
                mainViewPager.setCurrentItem(SmartChatConstant.PAGE_FIVE);
                changeRadioButtonState(SmartChatConstant.PAGE_FIVE);
                break;
        }
    }
...
//    }
    ...
    public void setTitlebar(int page) {
        ...
        switch (page) {
            ...
            case SmartChatConstant.PAGE_FIVE:
                ralat_layout_title_bar.setVisibility(View.VISIBLE);
                tv_title_bar_center.setText("游戏");
                iv_title_bar_more.setVisibility(View.INVISIBLE);
                break;
        }
    }
